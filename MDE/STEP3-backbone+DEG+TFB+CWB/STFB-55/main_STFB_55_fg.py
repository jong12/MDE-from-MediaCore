...
########################################################################################################################
        ...
        for step in range(start_step, start_step+num_total_steps):
            ...
            if (step == start_step) or (step % 100) == 0:
                ...
                save34_3 = np.zeros(shape=(5,32,64,128)) 
                save34_4 = np.zeros(shape=(5,32,64,128))
                ...
                _, loss_value,save34_tmp,save45_tmp = sess.run([apply_gradient_op, total_loss, model.save34, model.save45], 
                                                               feed_dict = {model.pre_nonlocal_conv34_1:save34_1, 
                                                                            ...
                                                                            model.pre_nonlocal_conv34_3:save34_3, 
                                                                            model.pre_nonlocal_conv34_4:save34_4,
                ...
                #save34_2, save34_3, save34_4 = np.zeros(shape=(5,32,64,128))
                #save45_2, save45_3, save45_4 = np.zeros(shape=(5,16,32,256))
                ...
                #save34_3, save34_4 = np.zeros(shape=(5,32,64,128))
                #save45_3, save45_4 = np.zeros(shape=(5,16,32,256))
                _, loss_value,save34_tmp,save45_tmp = sess.run([apply_gradient_op, total_loss, model.save34, model.save45], 
                                                               feed_dict = {model.pre_nonlocal_conv34_1:save34_1, 
                                                                            model.pre_nonlocal_conv34_2:save34_2,
                                                                            model.pre_nonlocal_conv34_3:save34_3, 
...
def test(params):
    ...
    for step in range(count_text_lines(args.filenames_file)):
        ...
        if (step == 0) or (step % 200 == 0):
            ...
            save34_3 = np.zeros(shape=(2,32,64,128)) 
            save34_4 = np.zeros(shape=(2,32,64,128))
