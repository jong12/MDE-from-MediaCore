...
class MonodepthModel(object):
    ...
    def nonlocal_block(self, x, c, scope): #c=channel*1/2
        ...
        if scope =='nonlocal_3to4':
            ...
            self.pre_nonlocal_conv34_3 = tf.placeholder(tf.float32,shape=(self.batchsize, x.shape[1], x.shape[2], x.shape[3]))#1*1conv [B,H,W,c]
            self.pre_nonlocal_conv34_4 = tf.placeholder(tf.float32,shape=(self.batchsize, x.shape[1], x.shape[2], x.shape[3]))#1*1conv [B,H,W,c]
            ...
            nonlocal1_t_3 = self.pre_nonlocal_conv34_3 #[B,H,W,c]
            nonlocal1_t_4 = self.pre_nonlocal_conv34_4 #[B,H,W,c]
        else:
            self.save45 = nonlocal1
