...
from model_4layer_partial import *
...
#########################################################################################################
                    ...
                    new_trainable_vars=[var for var in train_vars if (var.name.split('/')[2]!='conv_n1')and(var.name.split('/')[2]!='conv_n2')and(var.name.split('/')[2]!='conv_n3')and(var.name.split('/')[2]!='conv_n4')and(var.name.split('/')[2]!='edge_layer1')and(var.name.split('/')[2]!='edge_layer2')and(var.name.split('/')[2]!='edge_layer3')and(var.name.split('/')[2]!='edge_layer4')]
                    #new_trainable_vars=[var for var in train_vars]
                   # print("new_trainable_vars",new_trainable_vars)
...
########################################################################################################################
        ...
        if args.checkpoint_path != '':
            ...
            variables_to_restore = get_variables_to_restore(variables)
            #print('variables_to_restore',variables_to_restore)
